...
class CustomizedDapp {
    constructor(data) {
        ...
        let networks = [
            ...
            {name: 'zkEVM', img: _url_loader_img_matic_webp__WEBPACK_IMPORTED_MODULE_6__["default"], chainId: 1442, code: 'zkEVM'},
            {name: 'Optimism', img: _url_loader_img_eth_png__WEBPACK_IMPORTED_MODULE_1__["default"], chainId: 10, code: 'Optimism'},
            {name: 'Scroll', img: _url_loader_img_eth_png__WEBPACK_IMPORTED_MODULE_1__["default"], chainId: 534353, code: 'Scroll'}
        ]
        if (data.tokenFilter) {
